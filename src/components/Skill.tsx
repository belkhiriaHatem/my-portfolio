  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        src={img}
        className="h-20 w-20 rounded-full border-[5px] border-[#222523] object-cover filter transition duration-300 ease-in-out group-hover:grayscale xl:h-24 xl:w-24"
      />
